...
public sealed class EngineComponent : Component
{
    ...
    [Property, Range( 0, 500f ), DefaultValue( 15f )] public float bodyOffsetZ;
    [Property, Range( 0, 2000f ), DefaultValue( 1400f )] public float turnSpeed;
    [Property, Range( 0, 20000f ), DefaultValue( 6000f )] public float gravity;
	...
	protected override void OnFixedUpdate()
	{
		...
		if ( inputActive )
		{
			...
			var dx = Mouse.Delta.x == 0 ? 0 : Mouse.Delta.x / Math.Abs( Mouse.Delta.x ) * 600f * 0.4f;
			var dy = Mouse.Delta.y == 0 ? 0 : Mouse.Delta.y / Math.Abs( Mouse.Delta.y ) * 600f;
			var dz = 0f;
